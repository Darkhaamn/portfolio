...
export default function Page() {
  ...
  return (
    <div
      className="scroll-smooth min-h-dvh text-zinc-700 dark:text-zinc-400 antialiased selection:bg-zinc-200 dark:selection:bg-zinc-700 selection:text-zinc-950 dark:selection:text-white pb-20"
    >
        ...
        <section id="about" className="mb-16 scroll-mt-24">
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
            <div className="space-y-4 max-w-lg">
              ...
              <h1 className="text-4xl md:text-5xl font-medium text-zinc-950 dark:text-zinc-100 tracking-tight leading-[1.1]">
