...
export const works: Work[] = [
  {
    ...
    summary:
      "Mongolia's first public cloud platform, allowing users to create and manage virtual machines, storage, and networks.",
    paragraphs: [
    ...
    stack:
      "React, TypeScript, Python, Go, OpenStack, Docker, Kubernetes, MariaDB, Redis, RabbitMQ, Nginx, AWS",
  ...
  },
  {
    ...
    stack:
      "React, TypeScript, Python, Go, OpenStack, Docker, Kubernetes, MariaDB, Redis, RabbitMQ, Nginx, Local Payment APIs",
    links: [
  ...
  },
  {
    ...
    summary:
      "Migrated one of Mongolia’s largest universities to AWS during COVID-19, ensuring reliable online learning for thousands of students.",
    paragraphs: [
    ...
    stack:
      "AWS (EC2, S3, CloudFront, RDS, Elastic Load Balancer, Auto Scaling, Route 53), Nginx, PHP, MySQL, Redis, CloudWatch",
    links: [
      {
  ...
  },
  {
    ...
    summary:
      "International eSIM services for travelers, powered by a Mongolian super app.",
    paragraphs: [
    ...
    stack:
      "React, TypeScript, Golang, PostgreSQL, REST API, QR Code Automation, Payment Gateway Integration, Super App SDK",
  ...
  },
  {
    ...
    summary:
      "MedOrder ecosystem: admin & supplier portals with real-time order tracking and scalable microservices.",
    paragraphs: [
    ...
    stack:
      "React, TypeScript, Golang, PostgreSQL, Redis, Docker, Kubernetes, Microservices, REST API, IOT, License Management API integration",
    links: [
